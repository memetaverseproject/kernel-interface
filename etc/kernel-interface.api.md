## API Report File for "@beland/kernel-interface"
...
//
// src/beland-crypto.ts:49:3 - (ae-forgotten-export) The symbol "IdentityType" needs to be exported by the entry point index.d.ts
// src/beland-crypto.ts:51:3 - (ae-forgotten-export) The symbol "AuthChain" needs to be exported by the entry point index.d.ts
